...
@section('content')
      ...
      <div class="wks-page-header">
        <div>
          ...
          <p class="wks-page-desc">Real-time platform metrics and event streams. &nbsp;<span style="font-family:var(--wds-font-mono);font-size:var(--wds-font-size-xs);color:var(--wds-text-faint);">rendered in {{ number_format((hrtime(true) - START_REQUEST) / 1e6, 2) }} ms</span>
