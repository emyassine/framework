...
:root {
    ...
    --wds-multimode-color: var(--gray-950);
}

:where(.dark, .dark *) {
    --wds-multimode-color: var(--gray-50);
}

.fi-main { margin-inline: 0 !important; transition: opacity 0.25s ease-out, transform 0.25s ease-out; will-change: opacity, transform; padding-bottom:5rem;}
...
@media (min-width: 768px) {
    .fi-main { padding-bottom:5rem;}
}
@media (max-width: 768px) {
    .fi-main { padding-bottom:10rem;}
}
</style>
