...
.fi-ta-text-has-descriptions .fi-ta-text-item,
.fi-ta-text-has-descriptions .fi-ta-text-description {
...
.fi-ta-ctn::before {
    ...
    position: absolute;
    inset: -5px;
    border-radius: calc(var(--wds-radius-container) + 4px);
