...
{!! \Webkernel\Platform\Colors\Color::root_css() !!}
  ...
  --wds-topbar-height: 61px;
  --wds-app-rail-width: 60px;
  --wds-app-menu-width: 220px;
  --wds-sidebar-width: calc(var(--wds-app-rail-width) + var(--wds-app-menu-width));
  --wds-sidebar-width-collapsed: var(--wds-app-rail-width);
  --wds-sidebar-toggle-height: 2.5rem;
  --wds-sidebar-padding-x: 1rem;
  --wds-app-rail-bg: #0e1d30;
