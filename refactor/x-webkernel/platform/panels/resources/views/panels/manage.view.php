...
@endphp
@if (!empty($saved))
  <p class="w-flash">{{ lang('panel.saved') }}</p>
@endif
          ...
          <x-webkernel::section :heading="lang('panel.tab.branding')">
            ...
            <div class="w-form-row">
              ...
              <div style="display:grid;grid-template-columns:repeat(3,minmax(0,8em));gap:0.75em">
                <label class="w-form-hint">{{ lang('panel.field.primary') }}<input type="color" name="color_primary" value="{{ $g('color_primary', '#2563eb') }}" /></label>
                <label class="w-form-hint">{{ lang('panel.field.secondary') }}<input type="color" name="color_secondary" value="{{ $g('color_secondary', '#0f172a') }}" /></label>
                <label class="w-form-hint">{{ lang('panel.field.accent') }}<input type="color" name="color_accent" value="{{ $g('color_accent', '#0ea5e9') }}" /></label>
                <label class="w-form-hint">{{ lang('panel.field.primary') }} (dark)<input type="color" name="color_primary_dark" value="{{ $g('color_primary_dark', '#60a5fa') }}" /></label>
                <label class="w-form-hint">{{ lang('panel.field.secondary') }} (dark)<input type="color" name="color_secondary_dark" value="{{ $g('color_secondary_dark', '#e2e8f0') }}" /></label>
                <label class="w-form-hint">{{ lang('panel.field.accent') }} (dark)<input type="color" name="color_accent_dark" value="{{ $g('color_accent_dark', '#38bdf8') }}" /></label>
              </div>
            </div>
          </x-webkernel::section>
          ...
          <x-webkernel::section :heading="lang('panel.tab.locale')" :description="lang('panel.locale_help')">
            ...
            <div class="w-form-row">
              ...
              <div>
                ...
                <span class="w-form-hint">{{ lang('panel.field.allowed_locales_hint') }}</span>
              </div>
            </div>
            <div class="w-form-row">
