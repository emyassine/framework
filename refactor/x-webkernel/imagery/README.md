...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/webkernel/imagery.svg?style=flat-square)](https://packagist.org/packages/webkernel/imagery)
[![Total Downloads](https://img.shields.io/packagist/dt/webkernel/imagery.svg?style=flat-square)](https://packagist.org/packages/webkernel/imagery)
...
```bash
composer require webkernel/imagery
```
...
```bash
php artisan imagery:install-icons
```
...
php artisan imagery:install-icons --list

# Install all icon packages at once
php artisan imagery:install-icons --all
```
...
@source '../../../../vendor/webkernel/imagery/resources/views/**/*';
```
...
```bash
php artisan vendor:publish --tag="imagery-config"
```
...
When you install icon packages using `php artisan imagery:install-icons`, **PHP Enums are automatically generated** for type-safe icon usage:

```php
use Webkernel\Imagery\Enums\Heroicons;
use Webkernel\Imagery\Enums\GoogleMaterialDesignIcons;
use Webkernel\Imagery\Enums\PhosphorIcons;
...
```bash
php artisan imagery:generate-enums --all
```
...
```php
use Webkernel\Imagery\Enums\Icon;
...
```php
use Webkernel\Imagery\Forms\Components\IconPickerField;
...
```php
use Webkernel\Imagery\Tables\Columns\IconPickerColumn;
...
```php
use Webkernel\Imagery\Infolists\Components\IconPickerEntry;
...
After generating enums with `php artisan imagery:generate-enums`, you can use them anywhere in Filament:
