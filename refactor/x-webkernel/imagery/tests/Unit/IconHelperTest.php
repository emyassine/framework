...
final class IconHelperTest extends TestCase
{
    ...
    public function it_can_create_icon_from_full_name(): void
    {
        ...
        $this->assertEquals('heroicons', $icon->get_set());
    }

    #[Test]
    public function it_returns_correct_set_name(): void
    {
        $this->assertEquals('heroicons', Icon::heroicon('users')->get_set());
        $this->assertEquals('google-material-design-icons', Icon::material('home')->get_set());
        $this->assertEquals('phosphor-icons', Icon::phosphor('heart')->get_set());
    }
}
