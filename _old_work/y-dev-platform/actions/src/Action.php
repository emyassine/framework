...
use Webkernel\Platform\Actions\Concerns\CanOpenModal;
use Webkernel\View\Htmlable;
use Webkernel\Platform\Components\Concerns\HasExtraAttributes;

/**
 * Schema / page action. Renders as a Button. Callbacks run from the Page POST.
 *
 * //> Specialized CRUD actions live beside this class (CreateAction, EditAction, …).
 */
class Action extends StaticComponent implements Htmlable, \Stringable
{
